...
def exit_profile_config(name: str) -> BacktestExitProfileConfig:
    ...
    if name == (
        "conservative-v1-m15-slope-positive-max-trades-8-"
        "target-3p0-breakeven-1p0-hold-32"
    ):
        return BacktestExitProfileConfig(
    ...
    if name == "conservative-v1-m15-slope-positive-max-trades-8-close-target-2p0-hold-32-drawdown-30pct":
        return BacktestExitProfileConfig(fixed_holding_bars=32, close_target_atr=2.0)
    if name == "conservative-v1-m15-slope-positive-max-trades-8-target-3p0-close-stop-1p0-hold-32":
        return BacktestExitProfileConfig(
            fixed_holding_bars=32,
            target_atr=3.0,
            close_stop_atr=1.0,
        )
    if name == "conservative-v1-m15-slope-positive-max-trades-8-target-4p0-close-stop-1p0-hold-32":
        return BacktestExitProfileConfig(
            fixed_holding_bars=32,
            target_atr=4.0,
            close_stop_atr=1.0,
        )
    if name == "conservative-v1-m15-slope-positive-max-trades-8-close-target-2p0-close-stop-1p0-hold-32":
        return BacktestExitProfileConfig(
            fixed_holding_bars=32,
            close_target_atr=2.0,
            close_stop_atr=1.0,
    ...
    if name == "conservative-v1-m15-slope-positive-max-trades-8-partial-30-50-targets-1p0-2p0-hold-16":
        return BacktestExitProfileConfig(
            fixed_holding_bars=16,
            partial_targets=(
    ...
    if name == "conservative-v1-m15-slope-positive-max-trades-8-partial-50-close-target-1p0-hold-16":
        return BacktestExitProfileConfig(
            fixed_holding_bars=16,
            partial_targets=(
                BacktestPartialExitTargetConfig(
    ...
    if name == "conservative-v1-m15-slope-positive-max-trades-8-delayed-close-stop-1p0-after-4-hold-16":
        return BacktestExitProfileConfig(
            fixed_holding_bars=16,
            close_stop_atr=1.0,
    ...
    if name == (
        "conservative-v1-m15-slope-positive-max-trades-8-"
        "close-target-2p0-delayed-close-stop-1p0-after-4-hold-32"
    ):
        return BacktestExitProfileConfig(
            fixed_holding_bars=32,
            close_target_atr=2.0,
    ...
    if name == (
        "conservative-v1-m15-slope-positive-max-trades-8-"
        "target-3p0-trail-1p5-giveback-1p0-hold-32"
    ):
        return BacktestExitProfileConfig(
            fixed_holding_bars=32,
            target_atr=3.0,
    ...
    if name == (
        "conservative-v1-m15-slope-positive-max-trades-8-"
        "target-3p0-fav-timeout-1p0-after-4-hold-32"
    ):
        return BacktestExitProfileConfig(
            fixed_holding_bars=32,
            target_atr=3.0,
...
def run_batch_experiment(
    *,
    ...
    exit_profile_settings = (
        active_exit_config.model_dump(mode="json", exclude_none=True, exclude_defaults=True)
