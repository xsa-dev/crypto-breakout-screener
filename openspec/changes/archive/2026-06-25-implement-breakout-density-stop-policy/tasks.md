...
- [x] 2.1 Add failing tests for density support plan stop placement and audit metadata.
- [x] 2.2 Add failing tests for density-eating invalidation/reset decisions.
- [x] 2.3 Implement the minimal DTO/config/risk-manager logic to pass the tests.
...
- [x] 3.4 Run `npx --yes @fission-ai/openspec@1.4.1 validate implement-breakout-density-stop-policy --strict --no-interactive`.
